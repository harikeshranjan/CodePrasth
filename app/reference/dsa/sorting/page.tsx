...
export default function SortingPage() {
  ...
  const hardProblems = [
    "Maximum Gap (Using Radix Sort or Bucket Sort)",
    "Minimum Number of Swaps to Sort the Array",
    "Median in a Stream (Using Heaps)",
    "Sort Colors (3-Way Partitioning)",
    "Find All Anagrams in a String (Sliding Window + Sorting)",
    "Largest Number Formed from Array",
    "Compare Version Numbers (Custom Sorting)",
    "Rearrange String Such That No Two Adjacent Are Same (Greedy + Heap + Sort)"
  ];     
        ...
        <div className="md:ml-72 mt-8 px-7 max-w-4xl">
          ...
          <div className="flex flex-col space-y-4 mb-10">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl">
              This page contains the collection of problems related to sorting. Each problem is categorized into three levels: Easy, Medium, and Hard. You can filter the problems based on their difficulty level.
            </p>
              ...
              <TabsContent value="all" className="mt-6 space-y-8">
                ...
                <Card>
                  <CardHeader className="pb-3">
                    ...
                    <CardDescription>Foundational sorting manipulation techniques</CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader className="pb-3">
                    ...
                    <CardDescription>Advanced sorting algorithms and optimizations</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <ul className="grid md:grid-cols-2 gap-3">
