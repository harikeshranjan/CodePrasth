    ...
    <main className="w-full">
      <section className="flex flex-col space-y-12 py-20 md:mx-16 border-x border-foreground/20 border-dashed">
        ...
        <div className="w-full flex flex-col items-center justify-center space-y-12">
          <h1 className="text-6xl font-bold text-center">Learn</h1>
          <p className="text-center px-5 md:px-20 text-lg text-foreground/60 leading-8">
            The learn section is a collection of code snippets and concepts that are used in the development of the website or machine learning. Filter through the list of titles to refer the particular code snippet or concept you are looking for.
          </p>
