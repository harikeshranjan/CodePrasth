...
export default function StackPage() {
  ...
  const mediumProblems = [
    ...
    "Minimum Element in Stack (Constant Time)",
    "Celebrity Problem",
    "Implement Two Stacks in an Array",
    "Remove Consecutive Duplicates from Stack",
    "Largest Rectangle in Histogram"
  ];
  
  const hardProblems = [
    "Maximum Area in Binary Matrix (using Histogram Stack Logic)",
    "Sliding Window Maximum (Using Monotonic Stack)",
    "Expression Evaluation (Infix with Precedence)",
    "Design a Stack that Supports getMin(), push(), pop() in O(1)",
    "Longest Valid Parentheses",
    "The Stack that Supports Middle Element Access in O(1)",
    "Largest Rectangle Under Skyline (Hard Variant)",
        ...
        <div className="md:ml-72 mt-8 px-7 max-w-4xl">
          ...
          <div className="flex flex-col space-y-4 mb-10">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl">
              This page contains the collection of problems related to stacks. Each problem is categorized into three levels: Easy, Medium, and Hard. You can filter the problems based on their difficulty level.
            </p>
              ...
              <TabsContent value="all" className="mt-6 space-y-8">
                ...
                <Card>
                  <CardHeader className="pb-3">
                    ...
                    <CardDescription>Foundational stacks manipulation techniques</CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader className="pb-3">
                    ...
                    <CardDescription>Advanced stacks algorithms and optimizations</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <ul className="grid md:grid-cols-2 gap-3">
