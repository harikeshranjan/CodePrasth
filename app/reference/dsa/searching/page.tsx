...
export default function SearchingPage() {
  const easyProblems = [
    ...
    "Check if Element Exists in a 2D Matrix (Brute Force)",
  ...
  const hardProblems = [
    ...
    "Job Scheduling to Maximize Profit (with Binary Search)",
    "Minimum Number of Days to Make M Bouquets",
    "Find the Smallest Divisor Given a Threshold",
    "Split Array Largest Sum (Binary Search + Greedy)",
    "Search a Word in a Sorted Matrix (Optimized Binary Search)"
  ];    
        ...
        <div className="md:ml-72 mt-8 px-7 max-w-4xl">
          ...
          <div className="flex flex-col space-y-4 mb-10">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl">
              This page contains the collection of problems related to searching. Each problem is categorized into three levels: Easy, Medium, and Hard. You can filter the problems based on their difficulty level.
            </p>
              ...
              <TabsContent value="all" className="mt-6 space-y-8">
                ...
                <Card>
                  <CardHeader className="pb-3">
                    ...
                    <CardDescription>Foundational searching manipulation techniques</CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader className="pb-3">
                    ...
                    <CardDescription>Advanced searching algorithms and optimizations</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <ul className="grid md:grid-cols-2 gap-3">
